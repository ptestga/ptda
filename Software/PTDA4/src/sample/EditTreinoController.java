...
public class EditTreinoController {
    @FXML
    ...
    private String idtreino, paciente,  dataInicio,  dataFim,
            desc, notas, idTrat;

    EditTreinoController(String idtreino, String dataInicio, String dataFim, String desc, String notas,
                       String idTrat, String paciente) {
    ...
    private void setDados(){
        ...
        combo_trat_pacient.setValue(idTrat);
    ...
    public void initialize(){
        ...
        btn_trat_save.setOnAction(event -> {
            ...
            if(combo_trat_pacient.getSelectionModel().getSelectedItem() != null)
                trat = combo_trat_pacient.getSelectionModel().getSelectedItem();
            String dataInicio = "";
            ...
            if(trat.isEmpty() || dataInicio.isEmpty() || dataFim.isEmpty() ||
                ...
                if(Main.getDriver().editTreino(idtreino, descricao, notas, dataInicio, dataFim)){
                    Main.sucessNotification("Treino editado com sucesso!");
                    Main.closeStage(event);
                }else
                    Main.errorNotification("Erro ao editar treino!");
